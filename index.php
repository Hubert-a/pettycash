        ...
        <div class="container bg-transparent" >
            <div class="row">
                ...
                <div class="col-md-5 bg-light" >
                    ...
                    <form action="./views/home.php" class="form-container">
                        ...
                        <button type="submit" class="btn btn-block text-white" style="background: linear-gradient(35deg, #4442A6,rgba(119, 119, 255, 0.8));">Log in</button>
                        </div>
                    ...
                    <div class="mt-2 container" >
                        ...
                        <button type="submit" class="btn btn-block text-white"style="background: linear-gradient(35deg, #4442A6,rgba(119, 119, 255, 0.8));">Sign up</button>
                        </div>
